...
namespace GroupManager.TableHandling
{
    public class TableManager
    {
        ...
        public TableManager(string TableName)
        {
            ...
            try
            {
                ...
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=cs110032000a5f0dfd5;AccountKey=u3NrE1i1Obr1AhrKlENuAJs7BaDGDhm4FZ1cC42heEQZNV9i7eYS9Y+nd7nsaUoa/y33rDQnbNywMLaRGvtqPg==;EndpointSuffix=core.windows.net";
